...
void InitGraphics(GFX *GFX)
{
    ...
    Graphics_setForegroundColor(&GFX->context, GRAPHICS_COLOR_BLACK);
    Graphics_setBackgroundColor(&GFX->context, GRAPHICS_COLOR_WHITE);
    Graphics_setFont(&GFX->context, &g_sFontCm12);
